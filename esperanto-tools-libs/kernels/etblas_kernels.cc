...
template <typename T>
T *tensor4dElPtr(T *tensor, int n, int c, int h, int w, int ns, int cs, int hs,
                 int ws) {
  return &tensor[n * ns + c * cs + h * hs + w * ws];
}

static inline unsigned get_global_id_x(KernelRuntimeState_t *state_p,
                                       KernelWorkItemState_t *wi_state_p) {
  return wi_state_p->block_id_x * state_p->block_size_x +
         wi_state_p->local_id_x;
}

KERNEL_ENTRY void
CopyKernel_Int32_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                      KernelWorkItemState_t *wi_state_p) {
  {
...
KERNEL_ENTRY void
CopyKernel_Int8_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned len = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
SetKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned len = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
SetKernel_Int32_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned len = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
SetKernel_Int8_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                    KernelWorkItemState_t *wi_state_p) {
  {
    unsigned len = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
SigmoidKernel_Float_ETKERNEL_entry_point(char *args,
...
KERNEL_ENTRY void
TanhKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                      KernelWorkItemState_t *wi_state_p) {
  {
    unsigned len = *reinterpret_cast<unsigned *>(args + 0);
    float *devPtrX = *reinterpret_cast<float **>(args + 8);
    ...
    if (global_id < len) {
      devPtrY[global_id] =
          2.0f * device_rcpf(1.0f + device_expf(-2.0f * devPtrX[global_id])) -
          1.0f;
    }
  }
}

KERNEL_ENTRY void MulBroadcast2Kernel_Float_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
...
KERNEL_ENTRY void BinAddKernelBroadcast_False_Float_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
    float *a = *reinterpret_cast<float **>(args + 0);
...
KERNEL_ENTRY void
AddKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
...
KERNEL_ENTRY void
SubKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
    float *a = *reinterpret_cast<float **>(args + 8);
...
KERNEL_ENTRY void
MaxKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
    float *a = *reinterpret_cast<float **>(args + 8);
    ...
    if (global_id < len) {
      y[global_id] =
          (a[global_id] >= b[global_id]) ? a[global_id] : b[global_id];
    }
  }
}

KERNEL_ENTRY void
MinKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
    float *a = *reinterpret_cast<float **>(args + 8);
...
KERNEL_ENTRY void
MulKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
    float *a = *reinterpret_cast<float **>(args + 8);
...
KERNEL_ENTRY void
DivKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
    float *a = *reinterpret_cast<float **>(args + 8);
...
KERNEL_ENTRY void
CmpLTEKernel_Float_ETKERNEL_entry_point(char *args,
                                        KernelRuntimeState_t *state_p,
                                        KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
CmpEQKernel_Float_ETKERNEL_entry_point(char *args,
                                       KernelRuntimeState_t *state_p,
                                       KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
PowKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
    float *a = *reinterpret_cast<float **>(args + 8);
...
KERNEL_ENTRY void
SelectKernel_Float_ETKERNEL_entry_point(char *args,
                                        KernelRuntimeState_t *state_p,
                                        KernelWorkItemState_t *wi_state_p) {
  {
    unsigned n = *reinterpret_cast<unsigned *>(args + 0);
...
KERNEL_ENTRY void
Sgemm_v2_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                              KernelWorkItemState_t *wi_state_p) {
  {
    Sgemm_v2_KernelArgs_t *args_p =
        reinterpret_cast<Sgemm_v2_KernelArgs_t *>(args);
...
struct TensorData {
  ...
  void fma(bool is_first_pass, const TensorData &a, const TensorData &b,
...
KERNEL_ENTRY void
MatMulTensor_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                  KernelWorkItemState_t *wi_state_p) {
  MatMulTensor_KernelArgs_t *args_p =
      reinterpret_cast<MatMulTensor_KernelArgs_t *>(args);
  ...
  TensorLoadTrans transa =
      !is_transa ? TensorLoadTrans::None : TensorLoadTrans::Transpose32;
  TensorLoadTrans transb =
      !is_transb ? TensorLoadTrans::None : TensorLoadTrans::Transpose32;
  ...
  // This is technically 1D Kernel. Each work item compute 16x16 block of result
  // matrix.
  unsigned global_id = get_global_id_x(state_p, wi_state_p);
  ...
  if (global_id < blocks_x * blocks_y) {
    ...
    for (unsigned block_k = 0; block_k < blocks_k; block_k++) {
      const float *blockA =
          !is_transa ? &args_p->A[args_p->lda * block_y * BS + block_k * BS]
                     : &args_p->A[args_p->lda * block_k * BS + block_y * BS];
      const float *blockB =
          !is_transb ? &args_p->B[args_p->ldb * block_k * BS + block_x * BS]
                     : &args_p->B[args_p->ldb * block_x * BS + block_k * BS];
      int blockKelems = device_min(args_p->k - block_k * BS, BS);

      tensor_load(0, blockA, stridea, blockYelems, transa);
      tensor_load(16, blockB, strideb, blockKelems, transb);

      tensor_fma(is_first_pass, 0, 16, blockYelems, blockKelems, blockXelems,
                 TensorFmaType::F32);
...
KERNEL_ENTRY void
MatMulTensorInt8To32_ETKERNEL_entry_point(char *args,
                                          KernelRuntimeState_t *state_p,
                                          KernelWorkItemState_t *wi_state_p) {
  MatMulTensorInt8To32_KernelArgs_t *args_p =
      reinterpret_cast<MatMulTensorInt8To32_KernelArgs_t *>(args);
  ...
  bool is_transb = args_p->is_transb;
  TensorLoadTrans transa =
      !is_transa ? TensorLoadTrans::None : TensorLoadTrans::Transpose8;
  TensorLoadTrans transb = !is_transb ? TensorLoadTrans::Interleave8
                                      : TensorLoadTrans::TransposeInterleave8;
  static constexpr unsigned BS = 16; // BLOCK_SIZE
  ...
  if (global_id < blocks_x * blocks_y) {
    ...
    for (unsigned block_k = 0; block_k < blocks_k; block_k++) {
      const int8_t *blockA =
          !is_transa ? &args_p->A[args_p->lda * block_y * BS + block_k * BSK]
                     : &args_p->A[args_p->lda * block_k * BSK + block_y * BS];
      const int8_t *blockB =
          !is_transb ? &args_p->B[args_p->ldb * block_k * BSK + block_x * BS]
                     : &args_p->B[args_p->ldb * block_x * BS + block_k * BSK];
      int blockKelems = device_min(args_p->k - block_k * BSK, BSK) /
                        4; // k is always dividable by 4!!
...
KERNEL_ENTRY void
QuantizedMatMul_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  QuantizedMatMul_KernelArgs_t *args_p =
      reinterpret_cast<QuantizedMatMul_KernelArgs_t *>(args);
  unsigned len = args_p->n * args_p->m;
  ...
  if (global_id < len) {
    ...
    cEl = quantization::clip_i32_i8(
        device_roundf(args_p->invScale * sum + args_p->offsetc));
  }
}
 ...
 */
KERNEL_ENTRY void
ConvTailNHWC_Float_ETKERNEL_entry_point(char *args,
                                        KernelRuntimeState_t *state_p,
                                        KernelWorkItemState_t *wi_state_p) {
  ConvTailNHWC_KernelArgs_t *args_p =
      reinterpret_cast<ConvTailNHWC_KernelArgs_t *>(args);
  unsigned len =
      args_p->batch_size * args_p->out_c * args_p->out_h * args_p->out_w;
...
KERNEL_ENTRY void
ConvTailNHWC_Int8Q_ETKERNEL_entry_point(char *args,
                                        KernelRuntimeState_t *state_p,
                                        KernelWorkItemState_t *wi_state_p) {
  ConvTailNHWC_KernelArgs_t *args_p =
      reinterpret_cast<ConvTailNHWC_KernelArgs_t *>(args);
  ...
  if (global_id < len) {
    ...
    dest[global_id] = quantization::clip_i32_i8(
        device_roundf(float(conv_sum) * (matMulScale / args_p->outScale) +
                      args_p->outOffset));
  }
}

KERNEL_ENTRY void ConvolutionForward_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
...
#define ELEM_OUT(_n, _c, _h, _w)                                               \
  tensor4dEl((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,          \
    ...
    ConvolutionForward_KernelArgs_t *args_p =
        reinterpret_cast<ConvolutionForward_KernelArgs_t *>(args);
    unsigned len =
        args_p->out_n * args_p->out_c * args_p->out_h * args_p->out_w;
...
KERNEL_ENTRY void ConvolutionForward_Int8Q_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_n, _c, _h, _w)                                                \
...
KERNEL_ENTRY void
AddTensor_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_n, _c, _h, _w)                                                \
...
#define ELEM_OUT(_n, _c, _h, _w)                                               \
  tensor4dEl((float *)args_p->C, _n, _c, _h, _w, args_p->out_nStride,          \
             args_p->out_cStride, args_p->out_hStride, args_p->out_wStride)
    AddTensor_KernelArgs_t *args_p =
        reinterpret_cast<AddTensor_KernelArgs_t *>(args);
    unsigned len =
        args_p->out_n * args_p->out_c * args_p->out_h * args_p->out_w;
...
KERNEL_ENTRY void ActivationForward_Sigmoid_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN_P(_n, _c, _h, _w)                                              \
  tensor4dElPtr((const float *)args_p->x, _n, _c, _h, _w, args_p->in_nStride,  \
                args_p->in_cStride, args_p->in_hStride, args_p->in_wStride)
#define ELEM_OUT_P(_n, _c, _h, _w)                                             \
  tensor4dElPtr((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,       \
                args_p->out_cStride, args_p->out_hStride, args_p->out_wStride)
    ActivationForward_KernelArgs_t *args_p =
        reinterpret_cast<ActivationForward_KernelArgs_t *>(args);
...
KERNEL_ENTRY void ActivationForward_Relu_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN_P(_n, _c, _h, _w)                                              \
...
KERNEL_ENTRY void ActivationForward_Tanh_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN_P(_n, _c, _h, _w)                                              \
  ...
  tensor4dElPtr((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,       \
...

    {
      if (global_id < len) {
        ...
        float res =
            2.0f * device_rcpf(1.0f + device_expf(-2.0f * (*in_elem_p))) - 1.0f;
        blendResult(args_p->alpha.f, res, args_p->beta.f, *out_elem_p);
      }
    }
#undef ELEM_OUT_P
...
static void PoolingForward_Float_Impl(char *args, KernelRuntimeState_t *state_p,
                                      KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_n, _c, _h, _w)                                                \
  tensor4dEl((const float *)args_p->x, _n, _c, _h, _w, args_p->in_nStride,     \
...
#define ELEM_OUT(_n, _c, _h, _w)                                               \
  tensor4dEl((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,          \
             args_p->out_cStride, args_p->out_hStride, args_p->out_wStride)
    PoolingForward_KernelArgs_t *args_p =
        reinterpret_cast<PoolingForward_KernelArgs_t *>(args);
    unsigned len =
        args_p->out_n * args_p->out_c * args_p->out_h * args_p->out_w;
...
KERNEL_ENTRY void PoolingForward_Max_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  PoolingForward_Float_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void PoolingForward_AvgIn_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  PoolingForward_Float_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void PoolingForward_AvgEx_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  PoolingForward_Float_Impl(args, state_p, wi_state_p);
}

static void PoolingForward_Int8Q_Impl(char *args, KernelRuntimeState_t *state_p,
                                      KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_n, _c, _h, _w)                                                \
  tensor4dEl((const int8_t *)args_p->x, _n, _c, _h, _w, args_p->in_nStride,    \
...
KERNEL_ENTRY void PoolingForward_Max_Int8Q_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  PoolingForward_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void PoolingForward_AvgIn_Int8Q_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  PoolingForward_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void PoolingForward_AvgEx_Int8Q_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  PoolingForward_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void BatchNormalizationForwardInference_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN_P(_n, _c, _h, _w)                                              \
  tensor4dElPtr((const float *)args_p->x, _n, _c, _h, _w, args_p->in_nStride,  \
                args_p->in_cStride, args_p->in_hStride, args_p->in_wStride)
#define ELEM_SCALE_P(_n, _c, _h, _w)                                           \
  tensor4dElPtr((const float *)args_p->bnScale, _n, _c, _h, _w,                \
                args_p->bn_nStride, args_p->bn_cStride, args_p->bn_hStride,    \
                args_p->bn_wStride)
#define ELEM_BIAS_P(_n, _c, _h, _w)                                            \
  tensor4dElPtr((const float *)args_p->bnBias, _n, _c, _h, _w,                 \
                args_p->bn_nStride, args_p->bn_cStride, args_p->bn_hStride,    \
                args_p->bn_wStride)
#define ELEM_MEAN_P(_n, _c, _h, _w)                                            \
  tensor4dElPtr((const float *)args_p->estimatedMean, _n, _c, _h, _w,          \
                args_p->bn_nStride, args_p->bn_cStride, args_p->bn_hStride,    \
                args_p->bn_wStride)
#define ELEM_VAR_P(_n, _c, _h, _w)                                             \
  tensor4dElPtr((const float *)args_p->estimatedVariance, _n, _c, _h, _w,      \
                args_p->bn_nStride, args_p->bn_cStride, args_p->bn_hStride,    \
                args_p->bn_wStride)
#define ELEM_OUT_P(_n, _c, _h, _w)                                             \
  tensor4dElPtr((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,       \
    ...
    BatchNormalizationForwardInference_KernelArgs_t *args_p =
        reinterpret_cast<BatchNormalizationForwardInference_KernelArgs_t *>(
            args);
    unsigned len = args_p->n * args_p->c * args_p->h * args_p->w;
...

    {
      if (global_id < len) {
        ...
        float res =
            ((scale * (in - mean)) / device_sqrtf(epsilon + var)) + bias;
        blendResult(args_p->alpha.f, res, args_p->beta.f, *out_elem_p);
      }
    }
#undef ELEM_OUT_P
...
KERNEL_ENTRY void SoftmaxForward_Instance_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN_P(_n, _c, _h, _w)                                              \
...
#define ELEM_OUT_P(_n, _c, _h, _w)                                             \
  tensor4dElPtr((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,       \
                args_p->out_cStride, args_p->out_hStride, args_p->out_wStride)
    SoftmaxForward_KernelArgs_t *args_p =
        reinterpret_cast<SoftmaxForward_KernelArgs_t *>(args);
    ...
    // Number of elements 'reduce_len' which are should be reduced in this block
    // may be bigger then block size, so, each thread linearly reduces their own
    // part into 'partial_sum'.
    float partial_sum = 0.0f;
    for (unsigned lin_id = local_id; lin_id < reduce_len;
         lin_id += block_size) {
    ...
    if (get_lane_id() == 0) {
      ...
      // Put this value from each shire into separate cell of block shared
      // memory.
    ...
    // Step 2. reduce shire values reading they from smem sequentally in first
    // thread of block.
    if (local_id == 0) {
      float sum = 0.0f;
    ...
    // __syncthreads(): ensure total sum in smem_p[0] will be visible to all
    // threads in block
    llvm_nvvm_barrier0(state_p, wi_state_p);
...
KERNEL_ENTRY void SoftmaxForward_Channel_Float_ETKERNEL_entry_point(
    char *args, KernelRuntimeState_t *state_p,
    KernelWorkItemState_t *wi_state_p) {
  {
...
KERNEL_ENTRY void
TransformTensor_Float_ETKERNEL_entry_point(char *args,
                                           KernelRuntimeState_t *state_p,
                                           KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_n, _c, _h, _w)                                                \
...
#define ELEM_OUT(_n, _c, _h, _w)                                               \
  tensor4dEl((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,          \
             args_p->out_cStride, args_p->out_hStride, args_p->out_wStride)
    TransformTensor_KernelArgs_t *args_p =
        reinterpret_cast<TransformTensor_KernelArgs_t *>(args);
    unsigned len = args_p->n * args_p->c * args_p->h * args_p->w;
...
KERNEL_ENTRY void
TransformTensor_Int8_ETKERNEL_entry_point(char *args,
                                          KernelRuntimeState_t *state_p,
                                          KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_n, _c, _h, _w)                                                \
...
KERNEL_ENTRY void
BatchedAdd_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                KernelWorkItemState_t *wi_state_p) {
  BatchedAdd_KernelArgs_t *args_p =
      reinterpret_cast<BatchedAdd_KernelArgs_t *>(args);
...
KERNEL_ENTRY void
QuantizedBatchedAdd_ETKERNEL_entry_point(char *args,
                                         KernelRuntimeState_t *state_p,
                                         KernelWorkItemState_t *wi_state_p) {
  QuantizedBatchedAdd_KernelArgs_t *args_p =
      reinterpret_cast<QuantizedBatchedAdd_KernelArgs_t *>(args);
  unsigned len = args_p->n * args_p->slice_size;
  ...
  if (global_id < len) {
    ...
    float batchVal = quantization::dequantize(batch[i], args_p->batchScale,
                                              args_p->batchOffset);
    float sliceVal = quantization::dequantize(slice[s], args_p->sliceScale,
                                              args_p->sliceOffset);
    float destVal = batchVal + sliceVal;
    dest[i] =
        quantization::quantize(destVal, args_p->destScale, args_p->destOffset);
  }
}

KERNEL_ENTRY void
Insert_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                  KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_d0, _d1, _d2, _d3)                                            \
  tensor4dEl((const float *)args_p->x, _d0, _d1, _d2, _d3,                     \
             args_p->x_strides[0], args_p->x_strides[1], args_p->x_strides[2], \
             args_p->x_strides[3])
#define ELEM_OUT(_d0, _d1, _d2, _d3)                                           \
  tensor4dEl((float *)args_p->y, _d0, _d1, _d2, _d3, args_p->y_strides[0],     \
    ...
    unsigned len = args_p->sizes[3] * args_p->sizes[2] * args_p->sizes[1] *
                   args_p->sizes[0];
...

    {
      if (global_id < len) {
        ...
        int d1 = ((global_id / args_p->sizes[3]) / args_p->sizes[2]) %
                 args_p->sizes[1];
        int d0 = ((global_id / args_p->sizes[3]) / args_p->sizes[2]) /
                 args_p->sizes[1];
...
KERNEL_ENTRY void
Insert_Int64_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                  KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN(_d0, _d1, _d2, _d3)                                            \
  tensor4dEl((const int64_t *)args_p->x, _d0, _d1, _d2, _d3,                   \
             args_p->x_strides[0], args_p->x_strides[1], args_p->x_strides[2], \
             args_p->x_strides[3])
#define ELEM_OUT(_d0, _d1, _d2, _d3)                                           \
  tensor4dEl((int64_t *)args_p->y, _d0, _d1, _d2, _d3, args_p->y_strides[0],   \
             args_p->y_strides[1], args_p->y_strides[2], args_p->y_strides[3])
    Insert_KernelArgs_t *args_p = reinterpret_cast<Insert_KernelArgs_t *>(args);
    unsigned len = args_p->sizes[3] * args_p->sizes[2] * args_p->sizes[1] *
                   args_p->sizes[0];
...
KERNEL_ENTRY void
Gather_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                  KernelWorkItemState_t *wi_state_p) {
  {
    ...
    if (global_id < len) {
      ...
      const float *data_p =
          &(((const float *)
                 args_p->data)[args_p->indices[global_id] * args_p->data_ydim]);
...
KERNEL_ENTRY void
TopK_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                KernelWorkItemState_t *wi_state_p) {
  {
...
KERNEL_ENTRY void
LRN_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                               KernelWorkItemState_t *wi_state_p) {
  {
#define ELEM_IN_P(_n, _c, _h, _w)                                              \
  tensor4dElPtr((const float *)args_p->x, _n, _c, _h, _w, args_p->in_nStride,  \
...
#define ELEM_OUT_P(_n, _c, _h, _w)                                             \
  tensor4dElPtr((float *)args_p->y, _n, _c, _h, _w, args_p->out_nStride,       \
                args_p->out_cStride, args_p->out_hStride, args_p->out_wStride)
#define ELEM_SCALE_P(_n, _c, _h, _w)                                           \
  tensor4dElPtr((float *)args_p->scale, _n, _c, _h, _w, args_p->scale_nStride, \
...
KERNEL_ENTRY void
LogKernel_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  {
    unsigned len = *reinterpret_cast<unsigned *>(args + 0);
    float *devPtrX = *reinterpret_cast<float **>(args + 8);
...
KERNEL_ENTRY void
QuantizeKernel_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                    KernelWorkItemState_t *wi_state_p) {
  unsigned len = *reinterpret_cast<unsigned *>(args + 0);
  float *devPtrX = *reinterpret_cast<float **>(args + 8);
  ...
  if (global_id < len) {
    devPtrY[global_id] =
        quantization::quantize(devPtrX[global_id], scale, offset);
  }
}

KERNEL_ENTRY void
DequantizeKernel_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                      KernelWorkItemState_t *wi_state_p) {
  unsigned len = *reinterpret_cast<unsigned *>(args + 0);
  ...
  if (global_id < len) {
    devPtrY[global_id] =
        quantization::dequantize(devPtrX[global_id], scale, offset);
  }
}

KERNEL_ENTRY void
RescaleQuantizedKernel_ETKERNEL_entry_point(char *args,
                                            KernelRuntimeState_t *state_p,
                                            KernelWorkItemState_t *wi_state_p) {
  unsigned len = *reinterpret_cast<unsigned *>(args + 0);
  int8_t *devPtrX = *reinterpret_cast<int8_t **>(args + 8);
...
KERNEL_ENTRY void
Splat_Float_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                 KernelWorkItemState_t *wi_state_p) {
  {
...
KERNEL_ENTRY void
Splat_Int8_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                KernelWorkItemState_t *wi_state_p) {
  {
    Splat_KernelArgs_t *args_p = reinterpret_cast<Splat_KernelArgs_t *>(args);
    unsigned len = args_p->count;
...
KERNEL_ENTRY void
Splat_Int32_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                 KernelWorkItemState_t *wi_state_p) {
  {
    Splat_KernelArgs_t *args_p = reinterpret_cast<Splat_KernelArgs_t *>(args);
    unsigned len = args_p->count;
...
KERNEL_ENTRY void
Splat_Int64_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                 KernelWorkItemState_t *wi_state_p) {
  {
    Splat_KernelArgs_t *args_p = reinterpret_cast<Splat_KernelArgs_t *>(args);
    unsigned len = args_p->count;
...
static void ArithOp_Int8Q_Impl(char *args, KernelRuntimeState_t *state_p,
                               KernelWorkItemState_t *wi_state_p) {
  QuantizedArithOp_KernelArgs_t *args_p =
      reinterpret_cast<QuantizedArithOp_KernelArgs_t *>(args);
  ...
  if (global_id < len) {
    float aVal = quantization::dequantize(args_p->a[global_id], args_p->aScale,
                                          args_p->aOffset);
    float bVal = quantization::dequantize(args_p->b[global_id], args_p->bScale,
                                          args_p->bOffset);
    float yVal;
    switch (args_p->op) {
    ...
    case ETDNN_TENSOR_ARITH_OP_MAX:
      yVal = device_maxf(aVal, bVal);
      break;
    case ETDNN_TENSOR_ARITH_OP_MIN:
      yVal = device_minf(aVal, bVal);
      break;
    default:
      assert_unreachable();
    }
...
KERNEL_ENTRY void
AddKernel_Int8Q_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  ArithOp_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void
SubKernel_Int8Q_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  ArithOp_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void
MulKernel_Int8Q_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  ArithOp_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void
DivKernel_Int8Q_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  ArithOp_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void
MaxKernel_Int8Q_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  ArithOp_Int8Q_Impl(args, state_p, wi_state_p);
}

KERNEL_ENTRY void
MinKernel_Int8Q_ETKERNEL_entry_point(char *args, KernelRuntimeState_t *state_p,
                                     KernelWorkItemState_t *wi_state_p) {
  ArithOp_Int8Q_Impl(args, state_p, wi_state_p);
}
