...
//ETSOC map
#define ELF_ADDR_START    0x8300000000
#define LAYER_ADDR_START_1  0x8500000000
#define DATA_ADDR_START   0x8400000000
...
#define STACK_REGION_TOTAL_SIZE 0x0004000000 // 64MB
...
#define GLOBAL_MEM_REGION_SIZE  0x0040000000 // + 1GB
