...
etdnnStatus_t etdnnSetTensor4dDescriptorEx(etdnnTensorDescriptor_t tensorDesc,
                                           etdnnDataType_t dataType, int n,
...
etdnnStatus_t etdnnSetFilter4dDescriptor(etdnnFilterDescriptor_t filterDesc,
                                         ...
                                         etdnnTensorFormat_t format, int k,
                                         int c, int h, int w);
...
EXAPI
etdnnStatus_t etdnnSetConvolution2dDescriptor(
...
EXAPI
etdnnStatus_t etdnnSetPooling2dDescriptor(
...
EXAPI
etdnnStatus_t etdnnActivationForward(
...
EXAPI
etdnnStatus_t
etdnnActivationLinear(etdnnHandle_t handle, etdnnActivationMode_t mode,
...
EXAPI
etdnnStatus_t etdnnAddTensor(etdnnHandle_t handle, const void *alpha,
                             const etdnnTensorDescriptor_t aDesc, const void *A,
                             const void *beta,
                             const etdnnTensorDescriptor_t cDesc, void *C);
...
EXAPI
etdnnStatus_t etdnnBatchNormalizationForwardInference(
...
EXAPI
etdnnStatus_t etdnnGetConvolutionForwardAlgorithm(
...
EXAPI
etdnnStatus_t etdnnGetConvolutionForwardWorkspaceSize(
    etdnnHandle_t handle, const etdnnTensorDescriptor_t xDesc,
    const etdnnFilterDescriptor_t wDesc,
    const etdnnConvolutionDescriptor_t convDesc,
...
EXAPI
etdnnStatus_t
etdnnConvolutionForward(etdnnHandle_t handle, const void *alpha,
                        const etdnnTensorDescriptor_t xDesc, const void *x,
...
EXAPI
etdnnStatus_t etdnnBiasedConvolutionForward(
...
EXAPI
etdnnStatus_t etdnnTransformTensor(etdnnHandle_t handle, const void *alpha,
                                   const etdnnTensorDescriptor_t xDesc,
                                   const void *x, const void *beta,
                                   const etdnnTensorDescriptor_t yDesc,
                                   void *y);
...
EXAPI
etdnnStatus_t etdnnSplat(etdnnHandle_t handle, const void *val,
                         const etdnnTensorDescriptor_t yDesc, void *y);

EXAPI
etdnnStatus_t etdnnArithOp(etdnnHandle_t handle, etdnnArithOp_t op,
                           const etdnnTensorDescriptor_t xDesc, const void *x,
                           const etdnnTensorDescriptor_t yDesc, const void *y,
...
EXAPI
etdnnStatus_t etdnnLocalResponseNormalization(
...
etdnnStatus_t etdnnSelect(etdnnHandle_t handle,
                          ...
                          const void *cond, const etdnnTensorDescriptor_t zDesc,
                          void *z);
