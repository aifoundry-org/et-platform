...
static std::unordered_map<std::string, device_mgmt_api::DM_CMD> const commandCodeTable = {
  ...
  {"DM_CMD_GET_MODULE_DRIVER_REVISION", device_mgmt_api::DM_CMD::DM_CMD_GET_MODULE_DRIVER_REVISION},
  ...
  {"DM_CMD_GET_MODULE_TEMPERATURE_THROTTLE_STATUS", device_mgmt_api::DM_CMD::DM_CMD_GET_MODULE_TEMPERATURE_THROTTLE_STATUS},
  ...
  {"DM_CMD_GET_MM_THREADS_STATE", device_mgmt_api::DM_CMD::DM_CMD_GET_MM_THREADS_STATE}};
