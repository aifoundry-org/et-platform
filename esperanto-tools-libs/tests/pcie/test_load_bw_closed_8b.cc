...
//
// test_load_bw_closed_8b kernel test:
// Invokes the load_bw kernel and sends it a tensor
// with random pointers. Each minion will access 1000 random addresses
// resulting into closed page requests equally distributes across all memory controllers.
TEST_F(PCIEKernelLaunchTest, load_bw_closed_8b_kernel) {
