...
static const std::map<std::string, size_t> kInternalKernelMap = {
    {"MulBroadcast2Kernel_Float_Float",
     ETKERNEL_MulBroadcast2Kernel_Float_Float}, // used in kKernelRemapTable
    {"BinAddKernelBroadcast_False_Float_Float",
     ETKERNEL_BinAddKernelBroadcast_False_Float_Float}, // used in
                                                        // kKernelRemapTable
    ...
    {"SigmoidKernel_Float",
     ETKERNEL_SigmoidKernel_Float}, // used in kKernelRemapTable
    ...
    {"BatchNormalizationForwardInference_Float",
     ETKERNEL_BatchNormalizationForwardInference_Float},
    ...
    {"ActivationForward_Sigmoid_Float",
     ETKERNEL_ActivationForward_Sigmoid_Float},
...
uintptr_t getBuiltinKernelPcByName(const std::string &kernel_name) {
  ...
  THROW(join("Unexpected kernel name: ", kernel_name.c_str(), " [",
...
void cpuLaunch(const std::string &kernel_name, uintptr_t kernel_pc,
  ...
  default:
    THROW(join("No software implementation of kernel: ", kernel_name.c_str(),
               " [", demangle(kernel_name).c_str(), "]"));
  }
}
