...
pipeline {
  parameters {
    ...
    string(name: 'REPO_SSH_URL', defaultValue: 'git@gitlab.esperanto.ai:software/devicemanagement.git', description: 'Repository URL')
    string(name: 'REPO_NAME', defaultValue: 'deviceManagement', description: 'Repository name')
    string(name: 'GITLAB_SOURCE_BRANCH', defaultValue: '$gitlabSourceBranch', description: 'Name of the branch in Gitlab that triggered the current MR')
    string(name: 'GITLAB_TARGET_BRANCH', defaultValue: '$gitlabTargetBranch', description: 'Target branch where the current branch will be merged')
    string(name: 'GITLAB_MR_ID', defaultValue: '$gitlabMergeRequestIid', description: 'Identifier of the Gitlab MR that triggered the pipeline')
