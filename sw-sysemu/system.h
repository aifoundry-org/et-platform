...
public:
    ...
    // UARTs
    void pu_uart0_set_fd(int fd);
    void pu_uart1_set_fd(int fd);
    int pu_uart0_get_fd() const;
    int pu_uart1_get_fd() const;
    void spio_uart0_set_fd(int fd);
    void spio_uart1_set_fd(int fd);
    int spio_uart0_get_fd() const;
    int spio_uart1_get_fd() const;
...
inline void System::pu_uart0_set_fd(int fd)
{
    memory.pu_uart0_set_fd(fd);
}


inline void System::pu_uart1_set_fd(int fd)
{
    memory.pu_uart1_set_fd(fd);
}


inline int System::pu_uart0_get_fd() const
{
    return memory.pu_uart0_get_fd();
}


inline int System::pu_uart1_get_fd() const
{
    return memory.pu_uart1_get_fd();
}


inline void System::spio_uart0_set_fd(int fd)
{
    memory.spio_uart0_set_fd(fd);
}


inline void System::spio_uart1_set_fd(int fd)
{
    memory.spio_uart1_set_fd(fd);
}


inline int System::spio_uart0_get_fd() const
{
    return memory.spio_uart0_get_fd();
}


inline int System::spio_uart1_get_fd() const
{
    return memory.spio_uart1_get_fd();
}
