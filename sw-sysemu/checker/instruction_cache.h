...
class instruction_cache
{
    ...
    private:
        ...
        typedef std::unordered_map<uint64, instruction *>           inst_cache_hash_t;
        typedef std::unordered_map<uint64, instruction *>::iterator inst_cache_hash_it_t;
