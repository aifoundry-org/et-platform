...
extern void texsndh(xreg src1, xreg src2);
extern void texsnds(freg src1);
extern void texsndt(freg src1);
extern void texsndr(freg src1);
extern void texrcv(freg dst, const uint32_t imm);
