...
// Source: https://github.com/laudrup/lz4_stream
 ...
 *
 */
template <size_t SrcBufSize = 256> class basic_ostream : public std::ostream {
public:
    /**
...
private:
    ...
    private:
        ...
        void compress_and_write()
        {
            ...
            pbump(-orig_size);
            size_t ret
                = LZ4F_compressUpdate(ctx_, &dest_buf_.front(), dest_buf_.capacity(), pbase(), orig_size, nullptr);
            if (LZ4F_isError(ret) != 0) {
 ...
 *
 */
template <size_t SrcBufSize = 256, size_t DestBufSize = 256> class basic_istream : public std::istream {
public:
    /**
    ...
    public:
        ...
        int_type underflow() override
        {
            ...
            while (written_size == 0) {
                ...
                size_t ret = LZ4F_decompress(ctx_, &dest_buf_.front(), &dest_size, &src_buf_.front() + offset_,
                                             &src_size, nullptr);
                if (LZ4F_isError(ret) != 0) {
