...
class instruction
{
    public:
        ...
        void set_mnemonic(std::string mnemonic_);
        ...
        bool get_is_stall() const         { return is_stall; }
    ...
    private:
        ...
        bool            is_stall;         // If the instruction is a stall
        ...
        std::string     str_error;        // The instruction decode had an error
        func_ptr        emu_func;         // Pointer to the emulation function (null if error)
