...
class main_memory_region_scp_linear : public main_memory_region
{
    public:
        // Constructors and destructors
        main_memory_region_scp_linear(main_memory* parent, uint64_t base, uint64_t size, testLog& l, func_ptr_get_thread& get_th);
