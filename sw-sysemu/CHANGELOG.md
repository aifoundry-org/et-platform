...
- Update minimum CMake version requied to match default version found in ubuntu 22.04 (3.21)
- (Conan) fix includedirs for build context
- Add (conan/cmake) helper scripts
### Deprecated
### Removed
### Fixed
### Security
...
- [SW-20745] (CI) Added quality:sonarqube-check stage and fix
### Deprecated
### Removed
### Fixed
### Security
