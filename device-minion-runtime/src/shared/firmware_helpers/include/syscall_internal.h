...
#define SYSCALL_EVICT_L1_INT                 11
#define SYSCALL_CONFIGURE_PMCS_INT           12
#define SYSCALL_RESET_PMCS_INT               13
#define SYSCALL_SAMPLE_PMCS_INT              14
#define SYSCALL_CONFIGURE_COMPUTE_MINION     15
#define SYSCALL_CACHE_OPS_EVICT_SW_INT       16
#define SYSCALL_CACHE_OPS_FLUSH_SW_INT       17
#define SYSCALL_CACHE_OPS_LOCK_SW_INT        18
#define SYSCALL_CACHE_OPS_UNLOCK_SW_INT      19
#define SYSCALL_CACHE_OPS_INVALIDATE_INT     20
