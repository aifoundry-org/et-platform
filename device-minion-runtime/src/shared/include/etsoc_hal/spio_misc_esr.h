...
/*    /data/ssmith/work/repos/soc_hal/dv/common/scripts/semifore_css/bitfield_enum_doc.css */
/*                                                                         */
/* Generated on: Tue May 21 15:35:20 2019                                  */
/*           by: ssmith                                                    */
/*                                                                         */
...
typedef struct {
   union {
      struct {
         ...
         /* Source filename: spio_misc_esr.csr, line: 69                   */
         /* Description:                                                   */
         /**
         ...
         */
         uint32_t anyhalted0 : 1; /* bit 0; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 73                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.anyhalted0 or AndOrTreeL1.anyhalted1 from 
          ...
          *    the halted status of 1024 harts
         */
         uint32_t anyhalted1 : 1; /* bit 1; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 77                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.anyhalted0 or AndOrTreeL1.anyhalted1 from 
         ...
         */
         uint32_t anyhalted2 : 1; /* bit 2; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 81                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.allhalted is set for each Minion shire in 
          *    the system with AndOrTreeL1.anyselected asserted.
         */
         uint32_t allhalted : 1; /* bit 3; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 85                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.anyrunning from any of the Minion shires in
          *     the system is set
         */
         uint32_t anyrunning : 1; /* bit 4; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 89                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.anyrunning from any of the Minion shires in
          *     the system is set
         */
         uint32_t allrunning : 1; /* bit 5; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 93                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.allrunning is set for each Minion shire in 
          *    the system with AndOrTreeL1.anyselected asserted.
         */
         uint32_t anyresumehack : 1; /* bit 6; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 97                   */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.allresumeack is set for each Minion shire 
          *    in the system with AndOrTreeL1.anyselected asserted.
         */
         uint32_t allresumehack : 1; /* bit 7; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 101                  */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.anyhavereset from any of the Minion shires 
          *    in the system is set.
         */
         uint32_t anyhavereset : 1; /* bit 8; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 105                  */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL1.allhavereset is set for each Minion shire 
          *    in the system with AndOrTreeL1.anyselected asserted.
         */
         uint32_t allhavereset : 1; /* bit 9; R/W; 0 */

         /* Source filename: spio_misc_esr.csr, line: 109                  */
         /* Description:                                                   */
         /**
          *    Set if AndOrTreeL0.anyunavailable from any neighborhood in the
          *     shire is set
         */
         uint32_t anyunavailable : 1; /* bit 10; R/W; 0 */
...
/* Source filename: spio_misc_esr.csr, line: 115                           */
/* Description:                                                            */
/**
...
typedef struct {
   union {
      struct {
         ...
         /* Source filename: spio_misc_esr.csr, line: 121                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 131                  */
         /* Description:                                                   */
         /**
          *    RW1S.  Writing to this register results in an atomic bitwise 
          *    OR of the current state of the register and the value to be 
...
/* Source filename: spio_misc_esr.csr, line: 145                           */
typedef struct {
   union {
      struct {

         /* Source filename: spio_misc_esr.csr, line: 146                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 150                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 156                           */
typedef struct {
   union {
      struct {

         /* Source filename: spio_misc_esr.csr, line: 157                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 164                           */
typedef struct {
   union {
      struct {

         /* Source filename: spio_misc_esr.csr, line: 165                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 173                           */
/* Description:                                                            */
/**
...
typedef struct {
   union {
      struct {
         ...
         /* Source filename: spio_misc_esr.csr, line: 176                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 181                  */
         /* Description:                                                   */
         /**
          *    Read only.  Currently pending service processor instruction 
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 186                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 191                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 196                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 201                  */
         /* Description:                                                   */
         /**
          *    Read only.  Which instruction cache ECC block the currently 
          *    pending service processor instruction cache ECC error 
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 206                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 213                           */
/* Description:                                                            */
/**
 *    Note the contents of this register are only valid when the 
 *    SP_ICACHE_ECC_INT_PEND interrupt pending bit is set.
...
typedef struct {
   union {
      struct {
         ...
         /* Source filename: spio_misc_esr.csr, line: 216                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 221                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 228                           */
typedef struct {
   union {
      struct {

         /* Source filename: spio_misc_esr.csr, line: 229                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 235                           */
typedef struct {
   union {
      struct {

         /* Source filename: spio_misc_esr.csr, line: 236                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 242                           */
typedef struct {
   union {
      struct {

         /* Source filename: spio_misc_esr.csr, line: 243                  */
         /* Description:                                                   */
         /**
         ...
         */
         ...
         /* Source filename: spio_misc_esr.csr, line: 247                  */
         /* Description:                                                   */
         /**
...
/* Source filename: spio_misc_esr.csr, line: 255                           */
/* Description:                                                            */
/**
...
typedef struct {
   ...
   Spio_misc_esr_AndOrTreeL2_t AndOrTreeL2; /**< Offset 0xc (R/W) */
