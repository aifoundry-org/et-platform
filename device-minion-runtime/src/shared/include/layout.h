...
#define FW_WORKER_TO_MASTER_MESSAGE_FLAGS                 CACHE_LINE_ALIGN(FW_GLOBAL_UART_LOCK_ADDR + FW_GLOBAL_UART_LOCK_SIZE)
...
#define CM_MM_IFACE_UNICAST_CIRCBUFFERS_SIZE              (MAX_SIMULTANEOUS_KERNELS * CM_MM_IFACE_CIRCBUFFER_SIZE)
...
static_assert((CM_MM_IFACE_UNICAST_CIRCBUFFERS_BASE_ADDR + CM_MM_IFACE_UNICAST_CIRCBUFFERS_SIZE) <
