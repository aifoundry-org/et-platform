...
#define FW_MASTER_TO_WORKER_LAUNCH_BARRIERS          CACHE_LINE_ALIGN(FW_MASTER_TO_WORKER_BROADCAST_MESSAGE_BUFFER + FW_MASTER_TO_WORKER_BROADCAST_MESSAGE_BUFFER_SIZE)
#define FW_MASTER_TO_WORKER_LAUNCH_BARRIERS_SIZE     (MAX_SIMULTANEOUS_KERNELS * LAUNCH_BARRIER_SIZE)
