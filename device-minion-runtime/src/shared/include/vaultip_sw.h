...
typedef struct VAULTIP_INPUT_TOKEN_REGISTER_READ_s {
    ...
    VAULTIP_INPUT_TOKEN_REGISTER_READ_WORD_3_63_t
        dw_03_63[VAULTIP_INPUT_TOKEN_REGISTER_READ_MAXIMUM_NUMBER];
...
typedef struct VAULTIP_OUTPUT_TOKEN_REGISTER_READ_s {
    VAULTIP_OUTPUT_TOKEN_REGISTER_READ_WORD_1_61_t
        dw_01_61[VAULTIP_INPUT_TOKEN_REGISTER_READ_MAXIMUM_NUMBER];
...
typedef struct VAULTIP_INPUT_TOKEN_REGISTER_WRITE_NON_INCREMENTAL_s {
    VAULTIP_INPUT_TOKEN_REGISTER_WRITE_NON_INCREMENTAL_ENTRY_t
        entries[VAULTIP_INPUT_TOKEN_REGISTER_WRITE_NON_INCREMENTAL_MAXIMUM_NUMBER];
...
static_assert(256 == sizeof(VAULTIP_FIRMWARE_RAM_TOKEN_t),
              "sizeof(VAULTIP_FIRMWARE_RAM_TOKEN_s) is not 256!");

#define VAULTIP_FIRMWARE_IMAGE_TYPE_FWp \
    0x705746 // 'FWp' // plain text image, only allowed if VaultIP OTP is all zero
...
#define VAULTIP_FIRMWARE_IMAGE_MAX_FILE_SIZE \
    (VAULTIP_MAXIMUM_FIRMWARE_SIZE + VAULTIP_FIRMWARE_HEADER_SIZE)
...
static_assert(4 == sizeof(VAULTIP_SUBVECTOR_HEADER_t),
              "sizeof(VAULTIP_SUBVECTOR_HEADER_t) is not 4!");
...
static_assert((4 + 4) == sizeof(VAULTIP_SUBVECTOR_32_t),
              "sizeof(VAULTIP_SUBVECTOR_32_t) is not 8!");
...
static_assert((4 + 8) == sizeof(VAULTIP_SUBVECTOR_64_t),
              "sizeof(VAULTIP_SUBVECTOR_64_t) is not 12!");
...
static_assert((4 + 32) == sizeof(VAULTIP_SUBVECTOR_256_t),
              "sizeof(VAULTIP_SUBVECTOR_256_t) is not 36!");
...
static_assert((4 + 48) == sizeof(VAULTIP_SUBVECTOR_384_t),
              "sizeof(VAULTIP_SUBVECTOR_384_t) is not 52!");
...
static_assert((4 + 68) == sizeof(VAULTIP_SUBVECTOR_521_t),
              "sizeof(VAULTIP_SUBVECTOR_521_t) is not 72!");
...
static_assert((4 + 256) == sizeof(VAULTIP_SUBVECTOR_2048_t),
              "sizeof(VAULTIP_SUBVECTOR_2048_t) is not 260!");
...
static_assert((4 + 384) == sizeof(VAULTIP_SUBVECTOR_3072_t),
              "sizeof(VAULTIP_SUBVECTOR_3072_t) is not 384!");
...
static_assert((4 + 512) == sizeof(VAULTIP_SUBVECTOR_4096_t),
              "sizeof(VAULTIP_SUBVECTOR_4096_t) is not 516!");
