...
#define IPI_TRIGGER(shire, bitmask) (*(volatile uint64_t* const)(0x01C0340090ULL + (shire << 22)) = bitmask)
#define IPI_TRIGGER_CLEAR(shire, bitmask) (*(volatile uint64_t* const)(0x01C0340098ULL + (shire << 22)) = bitmask)
