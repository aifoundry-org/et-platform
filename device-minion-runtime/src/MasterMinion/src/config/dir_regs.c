...
void DIR_Init(void)
{
    ...
    /* Populate the MMFW Trace region attributes */
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE]
        .type = MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE]
        .bar = MM_DEV_INTF_MMFW_TRACE_REGION_BAR;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE]
        .bar_offset = MM_DEV_INTF_MMFW_TRACE_REGION_OFFSET;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE]
        .bar_size = MM_DEV_INTF_MMFW_TRACE_REGION_SIZE;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE]
        .dev_address = 0U;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_MMFW_TRACE]
        .attributes_size = sizeof(MM_DEV_INTF_MEM_REGION_ATTR_s);
    ...
    /* Populate the CMFW Trace region attributes */
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE]
        .type = MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE]
        .bar = MM_DEV_INTF_CMFW_TRACE_REGION_BAR;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE]
        .bar_offset = MM_DEV_INTF_CMFW_TRACE_REGION_OFFSET;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE]
        .bar_size = MM_DEV_INTF_CMFW_TRACE_REGION_SIZE;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE]
        .dev_address = 0U;
    Gbl_MM_DIRs->mem_regions[MM_DEV_INTF_MEM_REGION_TYPE_OPS_CMFW_TRACE]
        .attributes_size = sizeof(MM_DEV_INTF_MEM_REGION_ATTR_s);
