...
enum MM_DEV_INTF_MM_BOOT_STATUS_e {
    ...
    MM_DEV_INTF_MM_BOOT_STATUS_DEV_INTF_READY = 1,
    MM_DEV_INTF_MM_BOOT_STATUS_INTERRUPT_INITIALIZED = 2,
    MM_DEV_INTF_MM_BOOT_STATUS_MM_CM_INTERFACE_READY = 3,
    MM_DEV_INTF_MM_BOOT_STATUS_CM_WORKERS_INITIALIZED = 4,
    MM_DEV_INTF_MM_BOOT_STATUS_MM_WORKERS_INITIALIZED = 5,
    MM_DEV_INTF_MM_BOOT_STATUS_MM_HOST_VQ_READY = 6,
    MM_DEV_INTF_MM_BOOT_STATUS_MM_SP_INTERFACE_READY = 7,
    MM_DEV_INTF_MM_BOOT_STATUS_MM_READY = 8
};
