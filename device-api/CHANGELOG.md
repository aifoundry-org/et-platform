...
### Added
### Changed
[SW-21898] Power throttling fixes and refactoring
### Deprecated
### Removed
### Fixed
### Security
...
### Added
### Changed
- [CI] update docker and conan to ubuntu 22.04
### Deprecated
### Removed
### Fixed
### Security
...
- [SW-19030] Reuse asset buffer for fru and vmin lut commands 
### Added
### Changed
### Deprecated
### Removed
 ...
 * Positioning `struct p2pdma_(read/write)_node` fields to be consistent with struct `dma_(read/write)_node` for future possibility of merging the structs.
 * Positioning fields in `struct p2pdma_(read/write)_node` such that peer device is always at same offset, so that the driver can translate the peer device address without identifying the command as read/write.
### Deprecated
### Removed
### Fixed
### Security
...
### Deprecated
### Removed
- [SW-15736] Removed auto code generation for device api, keeping include paths compatibility, this will be updated in future 2.0.0 release
### Fixed
### Security
