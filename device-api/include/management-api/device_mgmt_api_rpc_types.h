...
struct device_mgmt_default_rsp_t
{
    struct dev_mgmt_rsp_header_t rsp_hdr;
    int32_t
        payload; /**< Payload for default rsp. Will usually contain the status of command execution. */
    uint32_t pad; /**< Padding for alignment */
} __attribute__((packed, aligned(8)));
...
struct device_mgmt_certificate_hash_cmd_t
{
    dev_mgmt_cmd_header_t command_info; /**< Command header */
    struct certificate_hash_t
        certificate_hash; /**< Certificate hash. Size needs to be actually 32 bytes. */
} __attribute__((packed, aligned(8)));
...
struct device_mgmt_stats_run_control_cmd_t
{
    ...
    stats_control_e
        control; /**< This is a bit mask, each bit corresponds control a Stats Trace run control.
...
struct device_mgmt_trace_run_control_cmd_t
{
    dev_mgmt_cmd_header_t command_info; /**< Command header */
    trace_control_e
        control;    /**< This is a bit mask, each bit corresponds control a Trace run control.
...
struct mdi_write_gpr_cmd_t
{
    dev_mgmt_cmd_header_t command_info; /**< Command header */
    struct mdi_gpr_write_t
        cmd_attr; /**< Command attributes(hart_id,gpr index, data) for writing GPR */
} __attribute__((packed, aligned(8)));
...
struct mdi_write_csr_cmd_t
{
    dev_mgmt_cmd_header_t command_info; /**< Command header */
    struct mdi_csr_write_t
        cmd_attr; /**< Command attributes(hart_id,csr name, data) for writing to CSR */
} __attribute__((packed, aligned(8)));
...
struct mdi_mem_read_cmd_t
{
    dev_mgmt_cmd_header_t command_info; /**< Command header */
    struct mdi_mem_read_t
        cmd_attr; /**< Command attributes(memory address, size) for reading memory */
} __attribute__((packed, aligned(8)));
...
struct mdi_mem_write_cmd_t
{
    dev_mgmt_cmd_header_t command_info; /**< Command header */
    struct mdi_mem_write_t
        cmd_attr; /**< Command attributes(memory address, size, data) for writing to memory */
} __attribute__((packed, aligned(8)));
