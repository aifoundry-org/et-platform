...
enum POWER_THROTTLE_STATE {
  ...
  POWER_THROTTLE_STATE_POWER_UP = 1, /**<  */
  POWER_THROTTLE_STATE_POWER_DOWN = 2, /**<  */
  POWER_THROTTLE_STATE_THERMAL_DOWN = 3, /**<  */
  POWER_THROTTLE_STATE_POWER_SAFE = 4, /**<  */
  POWER_THROTTLE_STATE_THERMAL_SAFE = 5, /**<  */
};
