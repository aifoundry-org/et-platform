...
function(build_et_flatbuffers flatbuffers_schemas
                              schema_include_dirs
                              custom_target_name
                              additional_dependencies
                              generated_includes_dir
                              generated_jsonschema_dir
  ...
  foreach(schema ${flatbuffers_schemas})
    ...
    if (NOT ${generated_jsonschema_dir} STREQUAL "")
      set(generated_json ${generated_jsonschema_dir}/${filename}_generated.json)
      add_custom_command(
        OUTPUT ${generated_json}
        COMMAND ${FLATC}
        -o ${generated_jsonschema_dir}
        ${include_params}
        --jsonschema ${schema}
        DEPENDS ${FLATC_TARGET} ${schema} ${additional_dependencies}
        WORKING_DIRECTORY "${working_dir}")
      list(APPEND all_generated_files ${generated_json})
    endif()

    if (NOT ${generated_includes_cppraw_dir} STREQUAL "")
      set(generated_raw_include ${generated_includes_cppraw_dir}/${filename}_raw_generated.h)
      add_custom_command(
        OUTPUT ${generated_raw_include}
        COMMAND ${FLATC} ${FLATC_SCHEMA_ARGS}
        -o ${generated_includes_cppraw_dir}
        ${include_params}
        -C ${schema}
        DEPENDS ${FLATC_TARGET} ${schema} ${additional_dependencies}
        WORKING_DIRECTORY "${working_dir}")
      list(APPEND all_generated_files ${generated_raw_include})
    endif()
  ...
  if (NOT ${generated_jsonschema_dir} STREQUAL "")
    set_property(TARGET ${custom_target_name}
      PROPERTY GENERATED_JSONSCHEMA_DIR
      ${generated_jsonschema_dir})
  endif()
