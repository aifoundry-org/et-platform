...
pipeline {
  parameters {
    ...
    string(name: 'REPO_SSH_URL', defaultValue: 'git@gitlab.esperanto.ai:software/test-compute-kernels.git', description: 'Repository URL')
    string(name: 'REPO_NAME', defaultValue: 'test-compute-kernels', description: 'Repository name')
