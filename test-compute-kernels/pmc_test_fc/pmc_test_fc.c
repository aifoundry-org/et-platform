...
int64_t main(const kernel_params_t* const kernel_params_ptr)
{
	...
	uint64_t reduce_iter_idx =  (iter % NUM_RANDOM_SAMPLES) * REDUCE_PARAMS * TOTAL_MINIONS;
	...
	tensor_reduce(reduce_configs[reduce_minion_idx + REDUCE_START_REG_IDX + reduce_iter_idx],
		      reduce_configs[reduce_minion_idx + REDUCE_OP_IDX + reduce_iter_idx],
		      reduce_configs[reduce_minion_idx + REDUCE_NUM_REGS_IDX + reduce_iter_idx],
		      reduce_configs[reduce_minion_idx + REDUCE_PARTNER_IDX + reduce_iter_idx],
		      reduce_configs[reduce_minion_idx + REDUCE_ACTION_IDX + reduce_iter_idx]);
    }
