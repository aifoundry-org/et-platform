...
#define ETSOC_MEM_SHIRE_ESR_SIZE 0x40u
...
#define ETSOC_MEM_SHIRE_ESR_MS_ATOMIC_SM_CTL_OFFSET 0x8u
...
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_REVISION_ID_OFFSET 0x10u
...
#define ETSOC_MEM_SHIRE_ESR_MS_CLK_GATE_CTL_OFFSET 0x18u
...
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_STATUS_OFFSET 0x20u
...
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_CTL_ESR_MS_MC_EN_GET(x) \
   ((((uint64_t)x) & 0x0003000000000000ull) >> 48)
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_CTL_ESR_MS_MC_EN_SET(x) \
   ((((uint64_t)x) << 48) & 0x0003000000000000ull)
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_CTL_ESR_MS_MC_EN_MODIFY(r, x) \
   (((((uint64_t)x) << 48) & 0x0003000000000000ull) | ((r) & 0xfffcffffffffffffull))
...
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_CTL_ESR_MS_ADDR_MASK_GET(x) \
   ((((uint64_t)x) & 0x0000fff000000000ull) >> 36)
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_CTL_ESR_MS_ADDR_MASK_SET(x) \
   ((((uint64_t)x) << 36) & 0x0000fff000000000ull)
#define ETSOC_MEM_SHIRE_ESR_MS_MEM_CTL_ESR_MS_ADDR_MASK_MODIFY(r, x) \
   (((((uint64_t)x) << 36) & 0x0000fff000000000ull) | ((r) & 0xffff000fffffffffull))
