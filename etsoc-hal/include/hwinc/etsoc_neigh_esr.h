...
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_INFO_ECC_SATURATION_ADDRESS 0x80u
...
#define ETSOC_NEIGH_ESR_SIZE 0x10000ul
...
#define ETSOC_NEIGH_ESR_MINION_BOOT_OFFSET 0x18u
...
#define ETSOC_NEIGH_ESR_MPROT_OFFSET 0x20u
...
#define ETSOC_NEIGH_ESR_VMSPAGESIZE_OFFSET 0x38u
...
#define ETSOC_NEIGH_ESR_IPI_REDIRECT_PC_OFFSET 0x40u
...
#define ETSOC_NEIGH_ESR_PMU_CTRL_OFFSET 0x68u
...
#define ETSOC_NEIGH_ESR_NEIGH_CHICKEN_OFFSET 0x70u
...
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_CTL_OFFSET 0x78u
...
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_INFO_OFFSET 0x80u
...
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_ADDRESS_OFFSET 0x88u
...
#define ETSOC_NEIGH_ESR_ICACHE_SBE_DBE_COUNTS_OFFSET 0x90u
...
#define ETSOC_NEIGH_ESR_TEXTURE_CONTROL_OFFSET 0x8000u
...
#define ETSOC_NEIGH_ESR_TEXTURE_STATUS_OFFSET 0x8008u
...
#define ETSOC_NEIGH_ESR_TEXTURE_IMAGE_TABLE_PTR_OFFSET 0x8010u
...
#define ETSOC_NEIGH_ESR_HACTRL_OFFSET 0xff80u
...
#define ETSOC_NEIGH_ESR_HASTATUS0_OFFSET 0xff88u
...
#define ETSOC_NEIGH_ESR_HASTATUS1_OFFSET 0xff90u
...
#define ETSOC_NEIGH_ESR_AND_OR_TREEL0_OFFSET 0xff98u
...
#define ETSOC_NEIGH_ESR_NEIGH_CHICKEN_DEST_FIFO_GET(x) \
   ((((uint64_t)x) & 0x0000000000000018ull) >> 3)
#define ETSOC_NEIGH_ESR_NEIGH_CHICKEN_DEST_FIFO_SET(x) \
   ((((uint64_t)x) << 3) & 0x0000000000000018ull)
#define ETSOC_NEIGH_ESR_NEIGH_CHICKEN_DEST_FIFO_MODIFY(r, x) \
   (((((uint64_t)x) << 3) & 0x0000000000000018ull) | ((r) & 0xffffffffffffffe7ull))
...
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_INFO_SIZE 0x8u
...
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_INFO_SBE_DBE_SET_GET(x) \
   ((((uint64_t)x) & 0x0000000000007f00ull) >> 8)
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_INFO_SBE_DBE_SET_SET(x) \
   ((((uint64_t)x) << 8) & 0x0000000000007f00ull)
#define ETSOC_NEIGH_ESR_ICACHE_ERR_LOG_INFO_SBE_DBE_SET_MODIFY(r, x) \
   (((((uint64_t)x) << 8) & 0x0000000000007f00ull) | ((r) & 0xffffffffffff80ffull))
...
#define ETSOC_NEIGH_ESR_TEXTURE_STATUS_TB_IBUFF_OC_GET(x) \
   ((((uint64_t)x) & 0x00000000000000f8ull) >> 3)
#define ETSOC_NEIGH_ESR_TEXTURE_STATUS_TB_IBUFF_OC_SET(x) \
   ((((uint64_t)x) << 3) & 0x00000000000000f8ull)
#define ETSOC_NEIGH_ESR_TEXTURE_STATUS_TB_IBUFF_OC_MODIFY(r, x) \
   (((((uint64_t)x) << 3) & 0x00000000000000f8ull) | ((r) & 0xffffffffffffff07ull))
