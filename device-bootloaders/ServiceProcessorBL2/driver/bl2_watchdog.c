...
{
    iowrite32(WDT_WDT_CR_ADDRESS, WDT_WDT_CR_WDT_EN_WDT_EN_ENABLED);
...
{
    iowrite32(WDT_WDT_CR_ADDRESS, WDT_WDT_CR_WDT_EN_WDT_EN_DISABLED);
...
{
    //Feed the wdog
    iowrite32(WDT_WDT_CRR_ADDRESS, WDT_WDT_CRR_WDT_CRR_WDT_CRR_RESTART);
}
