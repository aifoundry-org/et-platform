...
//
static inline uint32_t ms_write_ddrc_reg (uint8_t memshire, uint32_t blk, uint32_t reg, uint32_t value) {
...
static inline uint32_t ms_poll_ddrc_reg ( uint8_t memshire, uint32_t blk, uint32_t reg, uint32_t wait_value, uint32_t wait_mask, uint32_t timeout_tries) {
   uint8_t done = 0;  
