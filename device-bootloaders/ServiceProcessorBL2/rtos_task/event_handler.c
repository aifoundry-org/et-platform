...
// TODO: watchdog timer event callback
...
int32_t dm_event_control_init(void) {
    ...
    q_handle = xQueueCreateStatic(
    DM_EVENT_QUEUE_LENGTH, DM_EVENT_QUEUE_ITEM_SIZE, DM_Queue_Storage, &g_staticQueue);
    ...
    t_handle = xTaskCreateStatic(dm_event_task_entry, "DM_EVENT_TASK",
    DM_EVENT_TASK_STACK, NULL,
