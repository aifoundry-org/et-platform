...
int crypto_derive_mac_key(ESPERANTO_MAC_TYPE_t mac_alg, uint32_t kdk_key, const void * derivation_data, size_t derivation_data_size, uint32_t * mac_key);
int crypto_derive_enc_key(uint32_t kdk_key, const void * derivation_data, size_t derivation_data_size, uint32_t * enc_key);
int crypto_delete_key(uint32_t key);

int crypto_mac_verify(ESPERANTO_MAC_TYPE_t mac_alg, const uint32_t mack_key,
