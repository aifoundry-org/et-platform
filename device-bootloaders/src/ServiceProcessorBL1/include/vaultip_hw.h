#ifndef __VAULT_IP_H__
#define __VAULT_IP_H__

#define MAILBOX_SIZE 256

#include <stdint.h>

typedef union _AIC_REGISTER_t {
    uint32_t u32;
    struct  {
...
typedef union _MAILBOX_RAWSTAT_t {
    uint32_t u32;
    struct {
        uint32_t mbx1_in_full : 1;
        uint32_t mbx1_out_full : 1;
...
typedef union _MAILBOX_RESET_t {
    uint32_t u32;
    struct {
        uint32_t reserved1 : 1;
        uint32_t mbx1_out_empty : 1;
...
typedef union _MAILBOX_LINKID_t {
    uint32_t u32;
    struct {
...
typedef union _MAILBOX_OUTID_t {
    uint32_t u32;
    struct {
...
typedef union _MAILBOX_LOCKOUT_t {
    uint32_t u32;
    struct {
...
typedef union _MODULE_STATUS_t {
    uint32_t u32;
    struct {
...
typedef struct _VAULTIP_HW_REGS_t {
