                 ...
                 uint8_t *hash)
{
    ...
    gs_input_token.hash.dw_03.InputDataAddress_31_00 = (uint32_t)(size_t)temp_msg;
    gs_input_token.hash.dw_04.InputDataAddress_63_32 = 0;
                         ...
                         uint32_t lifetime, uint32_t *asset_id)
{
    ...
    // MESSAGE_INFO_DEBUG("asset_create: policy=0x%08x_%08x, settings=0x%08x\n", policy_63_32, policy_31_00, other_settings);
    // for (n = 0; n < 6; n++) {
