...
void DIR_Init(void)
{
    ...
    /* Populate the SP Stats Trace buffer memory region attributes */
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].type =
        SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].bar =
        SP_DEV_INTF_SP_STATS_BUFFER_BAR;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].bar_offset =
        SP_DEV_INTF_SP_STATS_BUFFER_OFFSET;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].bar_size =
        SP_DEV_INTF_SP_STATS_BUFFER_SIZE;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].dev_address = 0U;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].attributes_size =
        sizeof(SP_DEV_INTF_MEM_REGION_ATTR_s);
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_SP_STATS_TRACE].access_attr =
        MEM_REGION_IOACCESS_SET(MEM_REGION_IOACCESS_ENABLED) |
        MEM_REGION_NODE_ACCESSIBLE_SET(MEM_REGION_NODE_ACCESSIBLE_MANAGEMENT) |
        MEM_REGION_DMA_ALIGNMENT_SET(MEM_REGION_DMA_ALIGNMENT_NONE);

    /* Populate the MM Stats Trace buffer memory region attributes */
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].type =
        SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].bar =
        SP_DEV_INTF_MM_STATS_BUFFER_BAR;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].bar_offset =
        SP_DEV_INTF_MM_STATS_BUFFER_OFFSET;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].bar_size =
        SP_DEV_INTF_MM_STATS_BUFFER_SIZE;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].dev_address = 0U;
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].attributes_size =
        sizeof(SP_DEV_INTF_MEM_REGION_ATTR_s);
    Gbl_SP_DIRs->mem_regions[SP_DEV_INTF_MEM_REGION_TYPE_MNGT_MM_STATS_TRACE].access_attr =
        MEM_REGION_IOACCESS_SET(MEM_REGION_IOACCESS_ENABLED) |
        MEM_REGION_NODE_ACCESSIBLE_SET(MEM_REGION_NODE_ACCESSIBLE_MANAGEMENT_OPS) |
        MEM_REGION_DMA_ALIGNMENT_SET(MEM_REGION_DMA_ALIGNMENT_NONE);
