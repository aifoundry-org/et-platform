...
#define PMIC_I2C_INT_CAUSE_REG_FAULT_MODIFY(r, x) \
   ((((x) << 7) & 0x80u) | ((r) & 0x7fu))
...
#define PMIC_I2C_BOARD_TYPE_ID_MODIFY(r, x) \
...
#define PMIC_I2C_BOARD_TYPE_MODIFICATION_REVISION_LEVEL_GET(x) \
   (((x) & 0x00ff0000ul) >> 16)
#define PMIC_I2C_BOARD_TYPE_MODIFICATION_REVISION_LEVEL_SET(x) \
   (((x) << 16) & 0x00ff0000ul)
...
#define PMIC_I2C_BOARD_TYPE_DESIGN_REVISION_LEVEL_GET(x) \
   (((x) & 0x0000ff00ul) >> 8)
#define PMIC_I2C_BOARD_TYPE_DESIGN_REVISION_LEVEL_SET(x) \
   (((x) << 8) & 0x0000ff00ul)
...
#define PMIC_I2C_BOARD_TYPE_TYPE_MODIFY(r, x) \
...
#define PMIC_I2C_REG_FAULT_REG_FAULT_ADDRESS_GET(x) \
   (((x) & 0x7f000000ul) >> 24)
#define PMIC_I2C_REG_FAULT_REG_FAULT_ADDRESS_SET(x) \
   (((x) << 24) & 0x7f000000ul)
...
#define PMIC_I2C_REG_FAULT_REG_FAULT_CMDREG_GET(x) \
   (((x) & 0x00ff0000ul) >> 16)
#define PMIC_I2C_REG_FAULT_REG_FAULT_CMDREG_SET(x) \
   (((x) << 16) & 0x00ff0000ul)
...
#define PMIC_I2C_REG_FAULT_REG_FAULT_VALUE_SET(x) \
   (((x) << 8) & 0x0000ff00ul)
...
#define PMIC_I2C_REG_FAULT_REG_FAULT_FIELD_VAL_GET(x) \
   (((x) & 0x0000007cul) >> 2)
#define PMIC_I2C_REG_FAULT_REG_FAULT_FIELD_VAL_SET(x) \
   (((x) << 2) & 0x0000007cul)
...
#define PMIC_I2C_REG_FAULT_REG_FAULT_MULTIPLE_GET(x) \
   (((x) & 0x00000002ul) >> 1)
#define PMIC_I2C_REG_FAULT_REG_FAULT_MULTIPLE_SET(x) \
   (((x) << 1) & 0x00000002ul)
...
#define PMIC_I2C_REG_FAULT_REG_FAULT_VALID_MODIFY(r, x) \
...
#define PMIC_I2C_REG_COM_FAIL_DETAILS_ADDRESS_GET(x) \
   (((x) & 0x007f0000ul) >> 16)
#define PMIC_I2C_REG_COM_FAIL_DETAILS_ADDRESS_SET(x) \
   (((x) << 16) & 0x007f0000ul)
...
#define PMIC_I2C_REG_COM_FAIL_DETAILS_CMDREG_GET(x) \
   (((x) & 0x0000ff00ul) >> 8)
#define PMIC_I2C_REG_COM_FAIL_DETAILS_CMDREG_SET(x) \
   (((x) << 8) & 0x0000ff00ul)
...
#define PMIC_I2C_REG_COM_FAIL_DETAILS_I2C_CODE_GET(x) \
   (((x) & 0x000000e0ul) >> 5)
#define PMIC_I2C_REG_COM_FAIL_DETAILS_I2C_CODE_SET(x) \
   (((x) << 5) & 0x000000e0ul)
...
#define PMIC_I2C_REG_COM_FAIL_DETAILS_ERR_TYPE_GET(x) \
   (((x) & 0x0000000cul) >> 2)
#define PMIC_I2C_REG_COM_FAIL_DETAILS_ERR_TYPE_SET(x) \
   (((x) << 2) & 0x0000000cul)
...
#define PMIC_I2C_REG_COM_FAIL_DETAILS_MULTIPLE_GET(x) \
   (((x) & 0x00000002ul) >> 1)
#define PMIC_I2C_REG_COM_FAIL_DETAILS_MULTIPLE_SET(x) \
   (((x) << 1) & 0x00000002ul)
...
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_ADDRESS_GET(x) \
   (((x) & 0x007f0000ul) >> 16)
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_ADDRESS_SET(x) \
   (((x) << 16) & 0x007f0000ul)
...
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_I2CS_HANDLERERR_GET(x) \
   (((x) & 0x00001f00ul) >> 8)
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_I2CS_HANDLERERR_SET(x) \
   (((x) << 8) & 0x00001f00ul)
...
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_I2CS_CLIENTERR_GET(x) \
   (((x) & 0x0000001cul) >> 2)
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_I2CS_CLIENTERR_SET(x) \
   (((x) << 2) & 0x0000001cul)
...
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_MULTIPLE_GET(x) \
   (((x) & 0x00000002ul) >> 1)
#define PMIC_I2C_COMMAND_COMM_FAIL_DETAILS_MULTIPLE_SET(x) \
   (((x) << 1) & 0x00000002ul)
...
#define PMIC_I2C_RESET_RESET_CAUSE_CAUSE_MODIFY(r, x) \
   (((x) & 0x000000fful) | ((r) & 0xffffff00ul))
