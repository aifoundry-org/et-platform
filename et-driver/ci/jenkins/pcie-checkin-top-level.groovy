...
pipeline {
  parameters {
    ...
    string(name: 'REPO_SSH_URL', defaultValue: 'git@gitlab.esperanto.ai:software/et-driver.git', description: 'Repository URL')
    string(name: 'REPO_NAME', defaultValue: 'pcie-driver', description: 'Repository name')
    ...
    booleanParam(name: 'RUN_OPS_PCIE_SYSEMU', defaultValue: 'true', description: 'Run OPS PCIE SysEMU job')
    booleanParam(name: 'RUN_MGMT_PCIE_SYSEMU', defaultValue: 'true', description: 'Run MGMT PCIE SysEMU job')
    booleanParam(name: 'RUN_VIRTUAL_PLATFORM', defaultValue: 'true', description: 'Run VIRTUAL_PLATFORM job')
  ...
  stages {
    stage('WRAPPER') {
      ...
      stages {
        ...
        stage('PARALLEL0') {
          parallel {
            ...
            stage('CLANG_CHECK') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/system-sw-integration/pipelines/linux-driver-clang-tests', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}", JOB_NAME: 'sw-platform/system-sw-integration/pipelines/linux-driver-clang-tests')
                      build job:
            ...
            stage('DM_TESTS_RECOVERY_MODE_PCIE_SYSEMU') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/dm-tests-recovery-mode-pcie-sysemu-1dev', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/dm-tests-recovery-mode-pcie-sysemu-1dev')
                      build job:
            ...
            stage('FIRMWARE_AND_DM_TESTS_PCIE_LOOPBACK') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/firmware-and-dm-tests-pcie-loopback-1dev', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/firmware-and-dm-tests-pcie-loopback-1dev')
                      build job:
            ...
            stage('FIRMWARE_AND_DM_TESTS_PCIE_SYSEMU') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/firmware-and-dm-tests-pcie-sysemu-1dev', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/firmware-and-dm-tests-pcie-sysemu-1dev')
                      build job:
        ...
        stage('PARALLEL1') {
          parallel {
            stage('BUILD_DRIVER_WITH_CENTOS_DEBUG_KERNEL') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/build-driver', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      def child_submodule_commits = get_child_submodule_commits(BRANCH: "${SW_PLATFORM_BRANCH}", COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/build-driver')
                      build job:
                        'sw-platform/virtual-platform/pipelines/build-driver',
                        propagate: true,
                        parameters: [
                          string(name: 'BRANCH', value: "${SW_PLATFORM_BRANCH}"),
                          string(name: 'COMPONENT_COMMITS', value: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}"),
                          string(name: 'KERNEL_BUILD_OPTS', value: 'centos-qemu'),
                          string(name: 'KERNEL_BUILD_TYPE', value: 'Debug'),
                          booleanParam(name: "FORCE_CHILD_RETRIGGER", value: "${FORCE_CHILD_RETRIGGER}"),
                          string(name: "SUBMODULE_COMMITS", value: child_submodule_commits),
                          string(name: 'INPUT_TAGS', value: "${env.PIPELINE_TAGS}")
                        ]
            ...
            stage('BUILD_DRIVER_WITH_CENTOS_RELEASE_KERNEL') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/build-driver', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      ...
                      build job:
                        ...
                        parameters: [
                          ...
                          string(name: 'COMPONENT_COMMITS', value: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}"),
                          string(name: 'KERNEL_BUILD_OPTS', value: 'centos-qemu'),
                          string(name: 'KERNEL_BUILD_TYPE', value: 'Release'),
                          booleanParam(name: "FORCE_CHILD_RETRIGGER", value: "${FORCE_CHILD_RETRIGGER}"),
                          string(name: "SUBMODULE_COMMITS", value: child_submodule_commits),
                          string(name: 'INPUT_TAGS', value: "${env.PIPELINE_TAGS}")
                        ]
            ...
            stage('BUILD_DRIVER_WITH_UBUNTU_DEBUG_KERNEL') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/build-driver', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
                      ...
                      build job:
                        ...
                        parameters: [
                          string(name: 'BRANCH', value: "${SW_PLATFORM_BRANCH}"),
                          string(name: 'COMPONENT_COMMITS', value: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}"),
                          string(name: 'KERNEL_BUILD_OPTS', value: 'ubuntu-native'),
                          string(name: 'KERNEL_BUILD_TYPE', value: 'Debug'),
                          booleanParam(name: "FORCE_CHILD_RETRIGGER", value: "${FORCE_CHILD_RETRIGGER}"),
                          string(name: "SUBMODULE_COMMITS", value: child_submodule_commits),
                          string(name: 'INPUT_TAGS', value: "${env.PIPELINE_TAGS}")
            ...
            stage('BUILD_DRIVER_WITH_UBUNTU_RELEASE_KERNEL') {
              steps {
                script {
                  if (need_to_retrigger(BRANCH: "${SW_PLATFORM_BRANCH}", JOB_NAME: 'sw-platform/virtual-platform/pipelines/build-driver', COMPONENT_COMMITS: "${COMPONENT_COMMITS},host-software/linuxDriver/etsoc1-pcie-driver:${BRANCH}")) {
                    script {
