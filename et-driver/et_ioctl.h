...
#define ETSOC1_IOCTL_GET_DEV_MGMT_SCRATCH_DRAM_BASE		\
	_IOR(ESPERANTO_PCIE_IOCTL_MAGIC, 13, __u64)

#define ETSOC1_IOCTL_GET_DEV_MGMT_SCRATCH_DRAM_SIZE		\
	_IOR(ESPERANTO_PCIE_IOCTL_MAGIC, 14, __u32)
