...
static ssize_t cmd_loopback_handler(struct et_squeue *sq)
{
	...
	struct device_mgmt_default_rsp_t dm_def_rsp = { 0 };
	struct device_mgmt_get_error_count_rsp_t dm_gec_rsp = { 0 };
	struct device_mgmt_dram_bw_counter_rsp_t dm_dbc_rsp = { 0 };
	struct device_mgmt_max_memory_error_rsp_t dm_mme_rsp = { 0 };
	struct device_mgmt_max_dram_bw_rsp_t dm_mdb_rsp = { 0 };
	struct device_mgmt_power_residency_rsp_t dm_mtt_rsp = { 0 };
	struct device_mgmt_max_temperature_rsp_t dm_mt_rsp = { 0 };
	struct device_mgmt_firmware_versions_rsp_t dm_fv_rsp = { 0 };
	struct device_mgmt_asset_tracking_rsp_t dm_at_rsp = { 0 };
	struct device_mgmt_power_state_rsp_t dm_ps_rsp = { 0 };
	struct device_mgmt_tdp_level_rsp_t dm_tl_rsp = { 0 };
	struct device_mgmt_temperature_threshold_rsp_t dm_tt_rsp = { 0 };
	struct device_mgmt_current_temperature_rsp_t dm_ct_rsp = { 0 };
	struct device_mgmt_throttle_residency_rsp_t dm_tht_rsp = { 0 };
	struct device_mgmt_module_power_rsp_t dm_mp_rsp = { 0 };
	struct device_mgmt_get_module_voltage_rsp_t dm_mv_rsp = { 0 };
	struct device_mgmt_get_asic_voltage_rsp_t dm_av_rsp = { 0 };
	struct device_mgmt_module_uptime_rsp_t dm_mu_rsp = { 0 };
	struct device_mgmt_asic_frequencies_rsp_t dm_af_rsp = { 0 };
	struct device_mgmt_dram_bw_rsp_t dm_db_rsp = { 0 };
	struct device_mgmt_dram_capacity_rsp_t dm_dc_rsp = { 0 };
	struct device_mgmt_asic_per_core_util_rsp_t dm_apcu_rsp = { 0 };
	struct device_mgmt_asic_stalls_rsp_t dm_as_rsp = { 0 };
	struct device_mgmt_asic_latency_rsp_t dm_al_rsp = { 0 };
	struct device_mgmt_mm_state_rsp_t dm_ms_rsp = { 0 };
	struct device_ops_echo_cmd_t *echo_cmd;
	struct device_ops_echo_rsp_t echo_rsp = { 0 };
	...
	struct device_ops_kernel_abort_rsp_t kernel_abort_rsp = { 0 };
