/*
 * Test: decoder_u32
 * Fills a trace with n_entries u32 values.
...
int main(int argc, const char **argv)
{
    ...
    srand(uargs.seed);
    {
        ...
        while (1) {
            ...
            if (!entry_header)
                break;
            CHECK_EQ(entry_header->type, TRACE_TYPE_VALUE_U32);
            entry = (const struct trace_value_u32_t *)entry_header;
