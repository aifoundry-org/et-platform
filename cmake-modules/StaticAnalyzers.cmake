...
if (ENABLE_CPPCHECK)
    ...
    message(STATUS "* cppcheck static analyzer not requested.")
endif()

# https://cmake.org/cmake/help/latest/prop_tgt/LANG_CLANG_TIDY.html
if (ENABLE_CLANG_TIDY)
    find_program(CLANG_TIDY_PROGRAM NAMES clang-tidy)
    set(COMMON_CLANG_TIDY_FLAGS "-checks=-*,readability-*,portability-*,performance-*,android-*,cppcoreguidelines-*,clang-analyzer-*,modernize-*,-modernize-use-trailing-return-type" "-extra-arg=-Wno-unknown-warning-option")
    ...
    message(STATUS "* clang-tidy static analyzer not requested.")
endif()
...
if (ENABLE_INCLUDE_WHAT_YOU_USE)
    ...
    message(STATUS "* include-what-you-use static analyzer not requested.")
endif()
...
if (ENABLE_CPPLINT)
    ...
    message(STATUS "* cpplint static analyzer not requested.")
endif()